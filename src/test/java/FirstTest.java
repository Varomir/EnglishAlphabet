...
public class FirstTest extends TestRunner {
    ...
    public void defaultEnglishLetterState() {
        ...
        LOG.debug("Before test-method01. Thread id is: " + Thread.currentThread().getId());
    ...
    public void defaultEnglishAlphabetState() {
        ...
        LOG.debug("Before test-method02. Thread id is: " + Thread.currentThread().getId());
    ...
    public void removeLetterFromTheGRID() {
        HomePage homePage = new HomePage(threadLocalDriver.get(), driverData);
        LOG.debug("Before test-method03. Thread id is: " + Thread.currentThread().getId());
    ...
    public void removeLetterFromTheTREE() {
        HomePage homePage = new HomePage(threadLocalDriver.get(), driverData);
        LOG.debug("Before test-method04. Thread id is: " + Thread.currentThread().getId());
    ...
    public void dragAndDropFromGridToTree() {
        ...
        LOG.warn("Before test-method05. Thread id is: " + Thread.currentThread().getId());
    ...
    public void dragAndDropFromTreeToGrid() {
        ...
        LOG.warn("Before test-method06. Thread id is: " + Thread.currentThread().getId());
